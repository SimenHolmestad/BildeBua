...
```
scp -r <brukernavn>@<ip_adresse>:<sti_til_bildebua>/BildeBua/backend/static/albums/<album_navn> <plassering_pa_din_maskin>
```
...
- BildeBua-prosjektet ligger i `~/projects` på Raspberry PI
...
```
scp -r pi@10.0.0.37:~/projects/BildeBua/backend/static/albums/halloween ~/Documents/halloween
```
